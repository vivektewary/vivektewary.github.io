...
<head>
    <title>Home | Quality Improvement in Mathematics Education</title>
<!-- Meta -->
      ...
      <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-collapse collapse sidebar-navbar-collapse">
          <ul class="nav navbar-nav">
           <!--<li class="nav-header"><img src="assets/images/LOGO5.png" height="100" width="275"></li>-->
            <li class="active"><a href="index.php">Home</a></li>
            <li><a href="loginpage.php">Log in</a></li>
            <li><a href="aboutus.php">About Us</a></li>
            <li><a href="news.php">News & Events</a></li>
                ...
                <ul class="slides">
                	<li>
                        ...
                        <p class="flex-caption">
                            <span class="main" >Algebra</span>
                           <br />
                            <span class="secondary clearfix" >Resource, Development & Collaboration</span>
                        </p>
                    </li>
		    <li>
                        <img src="assets/images/alice2.png" alt="" />
                        <p class="flex-caption">
                            <span class="main" >Geometry<json.loads(unicode(opener.open(...), "ISO-8859-1"))
/span>
                           <br />
                            <span class="secondary clearfix" >Resource, Development & Collaboration</span>
                        </p>
                	...
                	<li>
                        <img src="assets/images/output7.png" alt="" />
                        <p class="flex-caption">
                            <span class="main" >324 Trainers, 36 Districts, 408 Blocks</span>
                           <br />
                            <span class="secondary clearfix" >One Mission: Improving the Quality of Education</span>
                        </p>
                    </li>                 
                </ul><!--//slides-->
            </div><!--//flexslider-->
