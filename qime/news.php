...
<head>
    <title>News & Events | Quality Improvement in Mathematics Education</title>
<!-- Meta -->
...
<hr>
                    <h1 class="heading-title pull-left header15">News & Events</small></h1>
                    <div class="breadcrumbs pull-right">
                        <ul class="breadcrumbs-list">
                            <li class="breadcrumbs-label">You are here:</li>
                            <li><a href="../index.php">Home</a><i class="fa fa-angle-right"></i></li>
                            <li class="current">News and Events</li>
                        </ul>
                    </div><!--//breadcrumbs-->
                </header>
<hr>
...
<div class="row">
<article class="contact-form col-md-9 col-sm-9  page-row">                            
                            <h3 class="title">Quality Improvement in Math Education (QIME)</h3>
	<p align="justify">


Quality Improvement in Math Education (QIME) is a joint initiative by IIT Bombay and Rashtriya Madhyamik Shiksha Abhiyaan (RMSA) Maharashtra. The aim of this initiative to train and equip teachers in an effort to improve the quality of Mathematics education in the state. The principal and co-principal investigators for this project are Prof. Inder K. Rana and Prof. Santosh J. Gharpure from IIT Bombay. There are several initiatives running under this program.

If you are keen to be a part of this program or to know more please write an email to gom.vbttp@gmail.com. Alternately, you can reach out to Megha Jadhav (9967343413) or Mahesh Verma (9892214035).
       </p>
</article>
</div>
</div>
